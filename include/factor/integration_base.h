...
class IntegrationBase
{
  public:
    ...
    /**
     * @brief IMU预积分传播方程，积分计算两个关键帧之间IMU测量的变化量，包含
     *  旋转delta_q 
     *  速度delta_v 
     *  位移delta_p
    ...
    void propagate(double _dt, const Eigen::Vector3d &_acc_1, const Eigen::Vector3d &_gyr_1)
    {
         ...
         * 
         *  result_delta_p: 利用当前imu数据计算预积分 P
         *  result_delta_q: 利用当前imu数据计算预积分 Q
         *  result_delta_v: 利用当前imu数据计算预积分V
         *  result_linearized_ba: 加速度偏置
         *  result_linearized_bg: 角速度偏置
         * 
         *  将计算的预积分结果保存到 delta_p、delta_q、delta_v、linearized_ba、linearized_bg
         */
